...
import {SET_EVENT, SET_EVENTS, UPDATE_SEARCH_CRITERIA, AUTHENTICATED_USER, INITIAL_STATE, SET_STEP_INDEX, SIGN_IN, SIGN_OUT } from '../utils/data';
...
function ApplicationContextProvider({ children }) {
  ...
  const authContext = useMemo(() => ({
    ...
    updateSearchCriteria: (data) => {
		...
		goToStep: (stepIndex) => dispatch({type: SET_STEP_INDEX, data: stepIndex})
	}), [state]);
